...
use fyrox::core::futures::{FutureExt, TryFutureExt};
use fyrox::renderer::storage;
use web_sys::Storage;
...
pub struct Game {
    ...
    /*storage: Box<dyn Future<Output=Storage>>,
    ws: Client<TcpStream>,*/
}
...
impl Game {
    pub fn new(override_scene: Handle<Scene>, context: PluginContext) -> Self {
        ...
        //let mut ws: dyn Future<Output = Client<TcpStream>> = util::make_ws_stuff(storage.clone());
